...
const getMentors = async (req, res) => {
  try {
    const mentors = await MentorUser.find().select("-password"); // exclude password if stored
...
export {getUser, getMentors,checkUsername, updateUserProfile, updateAvailability,
