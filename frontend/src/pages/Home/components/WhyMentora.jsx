...
<div data-aos="fade-up"
  ...
  <div className='relative'>
    <div className='w-fit p-4 bg-purple-200/40 rounded-xl text-purple-600 mx-auto'>
...
<div data-aos="fade-up"
  ...
  <div className='relative'>
    <div className='w-fit p-4 bg-cyan-200/40 rounded-xl text-cyan-600 mx-auto'>
...
<div className='relative'>
    <div className='w-fit p-4 bg-orange-200/40 rounded-xl text-orange-600 mx-auto'>
...
<div className='relative'>
    <div className='w-fit p-4 bg-green-200/40 rounded-xl text-green-600 mx-auto'>
