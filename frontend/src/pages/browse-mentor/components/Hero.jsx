...
<div className='text-center w-full flex justify-between md:justify-center items-center md:gap-20 mt-14'>
  ...
  <div className="absolute inset-0 bg-gradient-to-br from-purple-300-30 via-cyan-300/30 to-blue-300/10 rounded-xl backdrop-blur-lg opacity-100 transition-opacity duration-300 z-0" />
...
<div className='3ext-center p-13 m-2 rounded-lg overflow-hidden relative group transition-transform duration-300 ease-in-out hover:scale-105'>
 {/* Blur + Gradient Overlay on hover */}
  <div className="absolute inset-0 bg-gradient-to-br from-purple-300-30 via-green-300/30 to-blue-300/10 rounded-xl backdrop-blur-lg opacity-100 transition-opacity duration-300 z-0" />
<div className='relative '>
...
<span className='text-gray-500 my-2'>Sessions Completed</span>
  ...
  <div className='text-center p-10 m-2 rounded-lg overflow-hidden relative group transition-transform duration-300 ease-in-out hover:scale-105'>
   {/* Blur + Gradient Overlay on hover */}
  <div className="absolute inset-0 bg-gradient-to-br from-purple-300-30 via-orange-300/30 to-blue-300/10 rounded-xl backdrop-blur-lg opacity-100 transition-opacity duration-300 z-0" />
<div className='relative '>
