...
// Upcoming session list
    <div className="session-list flex w-full bg-white px-4 py-3 rounded-2xl drop-shadow-sm">
      <div className="session-list-contents flex items-center justify-between w-full">
        ...
        <button className="session-list-btn font-medium px-9 py-6 rounded-2xl bg-secondary-100   hover:bg-secondary-200 transition-colors duration-200 hover:cursor-pointer">
          Join
        </button>

        <div className="h-6 w-px bg-m-gray-300 rounded-full" />

        <button className="session-list-btn-non-primary bg-m-gray-100 hover:bg-m-gray-200 hover:cursor-pointer px-9 py-6 rounded-2xl flex items-center justify-center">
...
// Upcoming session list
    <div className="session-list flex w-full bg-white px-4 py-3 rounded-2xl drop-shadow-sm">
      <div className="session-list-contents flex items-center justify-between w-full">
        ...
        <button className="session-list-btn bg-secondary-100 text-secondary-700 px-5 py-2 rounded-lg font-medium hover:bg-secondary-200 hover:text-secondary-800 transition-colors duration-200 hover:cursor-pointer">
          Leave Review
        </button>
