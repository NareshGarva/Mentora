...
function MentorCard() {
  ...
  <div className="flex justify-between items-center gap-3 mt-6">
    <button className="border border-gray-400 text-gray-700 font-medium px-5 py-1.5 rounded-lg transition-all ease-in-out hover:bg-gray-100 ">View Profile</button>
    <button className="bg-indigo-600 text-white font-medium flex items-center gap-2 px-5 py-1.5 rounded-lg transition-all ease-in-out hover:bg-indigo-700">
